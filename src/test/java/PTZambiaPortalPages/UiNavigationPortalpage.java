...
import static Tests.PTZambiaPortalTest.*;
...
public class UiNavigationPortalpage {
    ...
    static String first_name_input = "//input[@name='[0].FirstName']";
    static String first_name_input2 = "//input[@name='[1].FirstName']";
    static String first_name_input3 = "//input[@name='[2].FirstName']";
    static String last_name_input ="//input[@name='[0].LastName']";
    static String last_name_input2 ="//input[@name='[1].LastName']";
    static String last_name_input3 = "//input[@name='[2].LastName']";
    static String mobile_number ="//input[@name='[0].PhoneNumber']";
    static String mobile_number2 ="//input[@name='[1].PhoneNumber']";
    static String mobile_number3 ="//input[@name='[2].PhoneNumber']";
    ...
    public static void verify_hyperfiber_accordion_element() throws IOException, InterruptedException {
        Thread.sleep(2000);
        String expectedTitleMAP = "Zamnet";
