...
import MagnoliaPortalPages.LandingPortalPage;
import MagnoliaPortalPages.LogInPortalPage;
import MagnoliaPortalPages.UiNavigationPortalpage;
...
public class MagnoliaPortalTest {
    ...
    public static void Setup() throws IOException, InterruptedException {
        ...
        driver.get("https://preprod.magnoliatreefibre.dev.aex.systems/");

        ExtentSparkReporter spark = new ExtentSparkReporter("target/MagnoliaPortal.html");
