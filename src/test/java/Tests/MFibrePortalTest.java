...
import MfibrePortalPages.LandingPortalPage;
import MfibrePortalPages.LogInPortalPage;
import MfibrePortalPages.UiNavigationPortalpage;
...
public class MFibrePortalTest {
    ...
    public static void Setup() throws IOException, InterruptedException {
        ...
        driver.get("https://preprod.mfibre.dev.aex.systems/");

        ExtentSparkReporter spark = new ExtentSparkReporter("target/MFibrePortal.html");
