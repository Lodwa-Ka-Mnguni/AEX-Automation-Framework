...
import UnifybrPortalPages.LandingPortalPage;
import UnifybrPortalPages.LogInPortalPage;
import UnifybrPortalPages.UiNavigationPortalpage;
...
public class UnifybrPortalTest {
    ...
    public static void Setup() throws IOException, InterruptedException {
        ...
        driver.get("https://preprod.unifybr.dev.aex.systems/");

        ExtentSparkReporter spark = new ExtentSparkReporter("target/UnifybrPortal.html");
