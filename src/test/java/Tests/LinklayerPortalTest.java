...
import LinklayerPortalPages.LandingPortalPage;
import LinklayerPortalPages.LogInPortalPage;
import LinklayerPortalPages.UiNavigationPortalpage;
...
public class LinklayerPortalTest {
    ...
    public static void Setup() throws IOException, InterruptedException {
        ...
        driver.get("https://preprod.linklayer.dev.aex.systems/");

        ExtentSparkReporter spark = new ExtentSparkReporter("target/LinklayerPortal.html");
