...
import NetStreamPortalPages.LandingPortalPage;
import NetStreamPortalPages.LogInPortalPage;
import NetStreamPortalPages.UiNavigationPortalpage;
...
public class NetStreamPortalTest {
    ...
    public static void Setup() throws IOException, InterruptedException {
        ...
        driver.get("https://preprod.netstream.dev.aex.systems/");

        ExtentSparkReporter spark = new ExtentSparkReporter("target/NetStreamPortal.html");
