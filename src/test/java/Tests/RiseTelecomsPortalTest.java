...
import RiseTelecomsPortalPages.LandingPortalPage;
import RiseTelecomsPortalPages.LogInPortalPage;
import RiseTelecomsPortalPages.UiNavigationPortalpage;
...
public class RiseTelecomsPortalTest {
    ...
    public static void Setup() throws IOException, InterruptedException {
        ...
        driver.get("https://preprod.risetelecoms.dev.aex.systems/");

        ExtentSparkReporter spark = new ExtentSparkReporter("target/RiseTelecomsPortal.html");
