...
import static Tests.MFibrePortalTest.*;
...
public class UiNavigationPortalpage {
    ...
    public static void enter_address_input22() throws InterruptedException {
        Thread.sleep(3000);
        driver.findElement(By.id(address_input2)).sendKeys("8, Palm Springs, R551, Stretford, Johannesburg, 1805, Gauteng");
        Thread.sleep(2000);
    ...
    public static void enter_address_input3() throws InterruptedException {
        Thread.sleep(2000);
        driver.findElement(By.id(address_input3)).sendKeys("45, Palm Springs, R551, Orange Farm, Johannesburg, 1805, Gauteng");
        Thread.sleep(2000);
    ...
    public static void enter_address_input() throws InterruptedException {
        Thread.sleep(2000);
        driver.findElement(By.xpath(address_input)).sendKeys("7, Palm Springs, R551, Stretford, Johannesburg, 1805, Gauteng");
        Thread.sleep(2000);
