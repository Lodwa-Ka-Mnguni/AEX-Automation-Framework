...
import static Tests.LinklayerPortalTest.captureScreenshot;
import static Tests.LinklayerPortalTest.driver;
import static Tests.LinklayerPortalTest.test;
import static Tests.LinklayerPortalTest.*;
...
public class UiNavigationPortalpage {
    ...
    static String admin_tabs = "/html/body/div[3]/div/div[2]/ul/li[4]/a";
    static String address_management_op = "//a[@title='Address Management']";
    static String Service_tab = "/html/body/div[3]/div/div[2]/ul/li[2]/a";
    ...
    static String ADD_SERVICES ="/html[1]/body[1]/div[3]/div[1]/div[2]/ul[1]/li[2]/ul[1]/li[3]/a[1]";
    ...
    static String manage_tab = "/html/body/div[3]/div/div[2]/ul/li[1]/a";
    ...
    static String manage_account_op ="//a[@title='Manage Account']";
    ...
    public static void enter_address_input22() throws InterruptedException {
        Thread.sleep(4000);
        driver.findElement(By.id(address_input2)).sendKeys("8, Sapphire Place, Belvedere, Durban, ZA, 4400, KwaZulu-Natal");
        Thread.sleep(2000);
    ...
    public static void enter_address_input3() throws InterruptedException {
        Thread.sleep(2000);
        driver.findElement(By.id(address_input3)).sendKeys("13, Scindian Street, Belvedere, Durban, ZA, 4400, KwaZulu-Natal");
        Thread.sleep(2000);
    ...
    public static void enter_address_input() throws InterruptedException {
        Thread.sleep(2000);
        driver.findElement(By.xpath(address_input)).sendKeys("1, Porchester Place, Belvedere, Durban, ZA, 4400, KwaZulu-Natal");
        Thread.sleep(2000);
    ...
    public static void verify_hyperfiber_accordion_element() throws IOException, InterruptedException {
        Thread.sleep(2000);
        String expectedTitleMAP = "Ballito ISP";
