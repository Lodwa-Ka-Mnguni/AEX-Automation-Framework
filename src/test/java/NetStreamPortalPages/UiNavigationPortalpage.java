...
import static Tests.NetStreamPortalTest.*;
import static Tests.NetStreamPortalTest.driver;
...
public class UiNavigationPortalpage {
    ...
    static String address_input ="//input[@id='Address0']";
    ...
    static String product_option_one ="//*[@id=\"ProductId0\"]/option[7]";
    static String product_option_two ="//*[@id=\"ProductId1\"]/option[12]";
    static String prodct_option_three ="//*[@id=\"ProductId2\"]/option[3]";
    ...
    public static void enter_address_input22() throws InterruptedException {
        Thread.sleep(3000);
        driver.findElement(By.id(address_input2)).sendKeys("537 14th St, Noordwyk, Midrand, 1687, South Africa");
        Thread.sleep(2000);
    ...
    public static void enter_address_input3() throws InterruptedException {
        Thread.sleep(2000);
        driver.findElement(By.id(address_input3)).sendKeys("2577 Mohlala St, Noordwyk, Midrand, 1687, South Africa");
        Thread.sleep(2000);
    ...
    public static void enter_address_input() throws InterruptedException {
        Thread.sleep(2000);
        driver.findElement(By.xpath(address_input)).sendKeys("2584 Mohlala St, Noordwyk, Midrand, 1687, South Africa");
        Thread.sleep(2000);
    ...
    public static void verify_hyperfiber_accordion_element() throws IOException, InterruptedException {
        Thread.sleep(2000);
        String expectedTitleMAP = "Afrihost";
