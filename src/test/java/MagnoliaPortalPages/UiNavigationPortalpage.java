...
import static Tests.MagnoliaPortalTest.*;
...
public class UiNavigationPortalpage {
    ...
    static String address_management_op = "//a[@title='Address Management']";
    static String Service_tab = "//a[normalize-space()='Services']";
    static String Dashboard_option = "/html[1]/body[1]/div[3]/header[1]/div[1]/div[1]/div[2]/ul[1]/li[3]/ul[1]/li[2]/a[1]";
    static String Service_dashdoard_header = "/html/body/div[4]/div/div/div/header/h1";
    static String summary_accordion_element = "//h4[@id='ui-id-1']";
    static String home_connect_accordion_element = "//h4[@id='ui-id-3']";
    ...
    static String Id_Number ="//input[@name='[0].IDNumber']";
    static String Id_Number2 ="//input[@name='[1].IDNumber']";
    static String Id_Number3 ="//input[@name='[2].IDNumber']";
    ...
    static String product_option_two ="//*[@id=\"ProductId1\"]/option[2]";
    static String prodct_option_three ="//*[@id=\"ProductId2\"]/option[1]";
    ...
    static String home_img = "//img[@alt='MagnoliaTreeFibre']";
    ...
    public static void enter_address_input22() throws InterruptedException {
        Thread.sleep(3000);
        driver.findElement(By.id(address_input2)).sendKeys("48354, Ntema Street, Rocklands, Bloemfontein, ZA, 9309, Free State");
        Thread.sleep(2000);
    ...
    public static void enter_address_input3() throws InterruptedException {
        Thread.sleep(2000);
        driver.findElement(By.id(address_input3)).sendKeys("50888, Unknown, Pelindaba, Bloemfontein, ZA, 9301, Free State");
        Thread.sleep(2000);
    ...
    public static void verify_ISP_Header() throws IOException, InterruptedException {
        Thread.sleep(2000);
        String expectedTitleISPH = "KC Pinnacle";
    ...
    public static void enter_address_input() throws InterruptedException {
        Thread.sleep(2000);
        driver.findElement(By.xpath(address_input)).sendKeys("44116, Thagane Street, Rocklands, Bloemfontein, ZA, 9309, Free State");
        Thread.sleep(2000);
    ...
    public static void verify_hyperfiber_accordion_element() throws IOException, InterruptedException {
        Thread.sleep(2000);
        String expectedTitleMAP = "Net Nine Nine";
