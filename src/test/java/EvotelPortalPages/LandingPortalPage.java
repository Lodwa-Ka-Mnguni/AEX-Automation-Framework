...
public class LandingPortalPage {
    // Locators
    public static String home_Title = "/html/body/div[4]/div/div/div/div[2]/div[3]/h4";
    ...
    private static final By login_button = By.xpath("/html/body/div[4]/div/div/div/div[4]/div[3]/p/a");

    // Actions
    public static void verify_home_page() throws IOException, InterruptedException {
        Thread.sleep(2000);
        String expectedTitleHF = "Already registered?";
        ...
        if (expectedTitleHF.equals(actualTitleHF)) {
            test.log(Status.PASS, "User is presented with the landing page");
            test.pass("Actual Result",
                    MediaEntityBuilder.createScreenCaptureFromPath(screenshotPath).build());
        } else {
            test.log(Status.FAIL, "Landing page title mismatch. Expected: " + expectedTitleHF + " but found: " + actualTitleHF);
